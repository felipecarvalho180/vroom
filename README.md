...
👉 **Meeting Controls**: Participants have full control over meeting aspects, emoji reactions, screen sharing, muting/unmuting, sound adjustments, grid layout, participant list view, and individual participant management (pinning, muting, unmuting, blocking, allowing video share).
...
```bash
git clone https://github.com/felipecarvalho180/vroom.git
cd vroom
```
